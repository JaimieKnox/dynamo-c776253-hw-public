...
Requires the [GitHub CLI](https://cli.github.com/) (`gh`). Replace `dynamo-c776253-hardware-embedded-and-low-level-systems`
with the repository you were assigned:

```bash
gh repo fork handshake-project-dynamo/dynamo-c776253-hardware-embedded-and-low-level-systems --clone
cd dynamo-c776253-hardware-embedded-and-low-level-systems
git checkout -b submission
#  ... build the task (see below) ...
git add -A && git commit -m "Task submission"
git push -u origin submission
gh pr create --repo handshake-project-dynamo/dynamo-c776253-hardware-embedded-and-low-level-systems --fill
```
