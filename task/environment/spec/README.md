...
- `force_meta_epoch` with `floor` and `epoch` (plants both meta copies at a chosen epoch and floor using the dual-copy recover path for the accompanying policy word)
