...
After any tear, reboot, or reclaim rewrite, the next sealed append lands in erased flash beyond every already-programmed well-formed header region. Tip reporting still comes only from complete records under the half-ring rule.
